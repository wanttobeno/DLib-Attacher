...
{//TODO можн?прикрутить алгоритм обьеденения пересекающих? блоков
...
{//TODO добавить расчёт таблиц?релоко? тл?каллбеко?
...
/*
  ...
  MaxLen: 268 435 455 байт (2 147 483 647 би? - обнаружени?
   одинарны? двойны? пакетных ?всех нечетных ошибок
*/
uint_least32_t Crc32(unsigned char *buf, size_t len)
{
